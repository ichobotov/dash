    ...
    for param in df[["MSM availability","PPP availability","Mean Nsat tracked","Mean Nsat used in PPP","PPP H95","P2P PPP H95","P2P Struna H95"]]:
         if not param in ["PPP availability","Mean Nsat used in PPP","PPP H95","P2P PPP H95","P2P Struna H95"]:
             ...
             graphs_list.append(dcc.Graph(id='graphs',
                       ...
                       figure=px.line(df[df['PVT'] == any_player], x='Date', y=param, title=param)))
         else:
            graphs_list.append(dcc.Graph(id='graphs',
                                         # config={'displayModeBar': False},
                                         # animate=True,
...
players = ['data_01.csv', 'data_02.csv', 'data_03.csv']
df_list = []
for data in players:
 df = pd.read_csv(data)
 df_list.append(df)
...
def render_content(start_date, end_date, players):
    print(players)
    # print(type(players))
